    ...
    return (
        <Grid>
            ...
            <Segment clearing>
                ...
                <Field component={TextAreaInput} name='description' row={3} placeholder='Description' value={activity.description} />
                ...
                <Button loading={submitting} floated='right' positive type='submit' disabled={loading || invalid || pristine} content='Submit' />
                <Button onClick={activity.id ? () => history.push(`/activities/${activity.id}`) : () => history.push('/activities')} floated='right' disabled={loading} type='button' content='Cancel' />
            </Form>
                )} />
